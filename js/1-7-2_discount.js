...
total += payment;
console.log(`Оформляем ваш заказ на сумму ${payment} со скидкой ${discount * 100} %`);
console.log(`Вы явлетесь нашим партнёром со скидкой ${discount * 100} %`);
console.log(`Общая сумма потраченого в магазине: ${total}`);